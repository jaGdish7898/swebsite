...
export default function ScrollableListWrapper({
    ...
    return (
        <div className={styles.wrapper}>
            ...
            {areNavArrowsVisible && <div onClick={handleOnClickRightArrow} className={rightArrowStyle} />}
        </div>
    )
}
